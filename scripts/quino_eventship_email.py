...
def build_message_html(events):
    ...
    for e in events:
        ...
        if link:
            html.append(f'<div>Event link: <a href="{link}">Open Event Link</a> ({link})</div>')
        ...
        html.append(f"<div>Venue draft link: <a href=\"{_gmail_compose_url(venue_subject, venue_body)}\">Open draft</a> ({_gmail_compose_url(venue_subject, venue_body)})</div>")
        html.append(f"<div>Speaker draft link: <a href=\"{_gmail_compose_url(speaker_subject, speaker_body)}\">Open draft</a> ({_gmail_compose_url(speaker_subject, speaker_body)})</div>")
        html.append("</li>")
    html.append("</ul>")
